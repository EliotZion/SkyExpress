...
//        );
    ...
    public PageResult pageQuery(OrdersPageQueryDTO ordersPageQueryDTO) {
        ...
        for (Orders order : page) {
            Long id = order.getId();
            List<OrderDetail> od_list = orderDetailMapper.getByOrderId(id);
            OrderVO orderVO = new OrderVO();
            BeanUtils.copyProperties(order, orderVO);
            orderVO.setOrderDetailList(od_list);
            list.add(orderVO);
        }
    ...
    public OrderVO getOrderDetail(Long id) {
        ...
        List<OrderDetail> od_list = orderDetailMapper.getByOrderId(ordersId);
        OrderVO orderVO = new OrderVO();
